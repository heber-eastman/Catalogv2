...
export function MembershipTab({ customerId, data, onMembershipUpdated }: MembershipTabProps) {
  ...
  return (
    <>
      ...
      <AssignMembershipDialog
        ...
        onOpenChange={setIsAssignDialogOpen}
        customerId={customerId}
        currentPlanId={data.currentMembership?.planId}
        onSuccess={onMembershipUpdated}
      />
    </>
  );
